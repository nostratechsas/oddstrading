...
export const es = {
  ...
  pricing: {
    ...
    lede: "Precios en USD, impuestos no incluidos. Empiezas con 7 días de demo; la integración es un pago único de puesta en marcha y Pro es licencia mensual. Todos incluyen la API REST, el esquema unificado y el onboarding con nuestro equipo.",
    featuredBadge: "Más elegido",
    freeLabel: "Gratis",
    billingLabels: { free: "7 días", once: "pago único", monthly: "/mes" },
    ...
    plans: ([
      {
        ...
        features: [
          ...
          "Acompañamiento de nuestro equipo de integración",
          "Sin tarjeta: al séptimo día decides",
        ],
      },
      {
      ...
      },
      {
        ...
        audience: "Para operar con toda la información del mercado.",
        scope: "Hasta 50 casas · dashboard completo",
        cta: "Elegir Pro",
        coverage: { label: "Hasta 50 casas de apuestas integradas", capped: false },
        valueNote:
          "Se levanta el tope de 20 casas y se abre el dashboard entero: mercados, análisis de movimientos, arbitraje y alertas en vivo.",
        features: [
          "Todo lo del plan Integración",
          "Dashboard completo, sin secciones bloqueadas",
          "Mercados y análisis de movimientos completos",
          "Arbitraje y cuotas mejoradas",
          "Alertas en vivo y soporte prioritario",
        ],
      },
    ] as Plan[]),
  },
  ...
  faq: {
    ...
    items: [
      ...
      { question: "¿Puedo pedir una casa o un mercado que no esté en la lista?", answer: "Sí. Los clientes de Pro pueden solicitar operadores o mercados adicionales; el tiempo medio de incorporación de una casa nueva es de 7 a 10 días hábiles, sin costo extra en la mayoría de los casos." },
  ...
  checkout: {
    ...
    steps: [
      ...
      { index: "03", title: "Pago", body: "Confirma y te llevamos a la pasarela." },
    ],
    ...
    summary: {
      ...
      cycle: "Ciclo",
      cycleValue: "Mensual",
      cycleOnce: "Pago único",
      subtotal: "Subtotal",
      taxes: "IVA 19%",
      total: "Total a pagar",
      submit: "Ir a pagar",
      sending: "Preparando el pago…",
      /** Conversion strip shown above the total. */
      fxLabel: "Se cobra en pesos colombianos",
      fxRate: "TRM del día",
      fxSource: "Superintendencia Financiera",
      fxLoading: "Consultando la tasa oficial…",
      fxError: "No pudimos consultar la tasa. Reintenta en unos minutos.",
      /** Only shown for the recurring tier. */
      lockNotice:
        "Este valor en pesos queda fijo de por vida: se calcula hoy con la TRM y no cambia aunque el dólar suba.",
    },
    result: {
      eyebrow: "Pago",
    ...
    payment: {
      ...
      failure: "No pudimos iniciar el pago. Inténtalo de nuevo.",
    },
