...
export const en: SiteContent = {
    ...
    plans: [
      ...
      },
      {
        ...
        features: [
          ...
          "Asian handicap, over/under and props",
          "Priority support",
        ],
      },
      {
        ...
        features: [
          ...
          "Shared Slack with a named engineer",
        ],
      },
    ],
  },
  ...
  faq: {
    ...
    items: [
      ...
      { question: "Can I request a book or market that isn't listed?", answer: "Yes. Pro customers and above can request additional operators or markets; onboarding a new book takes 7 to 10 business days on average, at no extra cost in most cases." },
