...
export const en: SiteContent = {
  ...
  checkout: {
    ...
    steps: [
      ...
      { index: "03", title: "Payment", body: "Confirm and we take you to the gateway." },
    ],
    ...
    summary: {
      ...
      cycle: "Billing cycle",
      cycleValue: "Monthly",
      cycleOnce: "One-off payment",
      subtotal: "Subtotal",
      taxes: "VAT 19%",
      total: "Total to pay",
      submit: "Go to payment",
      sending: "Preparing the payment…",
      fxLabel: "Charged in Colombian pesos",
      fxRate: "Official rate today",
      fxSource: "Superintendencia Financiera",
      fxLoading: "Checking the official rate…",
      fxError: "We couldn't check the rate. Try again in a few minutes.",
      lockNotice:
        "This peso amount is fixed for life: it is calculated today from the official rate and does not change even if the dollar rises.",
    },
    result: {
      eyebrow: "Payment",
    ...
    payment: {
      ...
      failure: "We couldn't start the payment. Please try again.",
    },
